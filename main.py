...
if __name__ == "__main__":
    ...
    from Modules.retieval import retrival_ui
    ...
    gui.render_list.append(retrival_ui())
    ...
    try:
        with open('yolo_res', 'rb') as f:
            gui.render_list[2].fb.pp.yolo_res = pickle.load(f)
    except:
        pass

    gui.render_list[2].fb.startprocess()
